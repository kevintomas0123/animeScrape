...
var PORT = process.env.PORT || 3000;// Initialize Express
var app = express();
...
app.get("/scrape", function (req, res) {
  ...
  axios.get("https://www.animenewsnetwork.com/news/").then(function (response) {
...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/anime";
